...
public class TransformProjectedH1Configuration : IEntityTypeConfiguration<TransformProjectedH1>
{
    public void Configure(EntityTypeBuilder<TransformProjectedH1> builder)
    {
        builder.ToTable("transform_projected_h1");
