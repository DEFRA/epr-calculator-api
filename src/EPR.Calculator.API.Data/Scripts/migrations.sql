...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241018085826_UpdateOtherMaterialsDefaultParameterMaster'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241018085826_UpdateOtherMaterialsDefaultParameterMaster', N'8.0.7');
END;
GO
