...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241104090354_AddNewColumnLapcapFileNameToLapcapDataMaster'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [calculator_run_classification] SET [created_at] = ''2024-11-04T09:03:54.0089390+00:00''
    WHERE [id] = 1;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [calculator_run_classification] SET [created_at] = ''2024-11-04T09:03:54.0089395+00:00''
    WHERE [id] = 2;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [calculator_run_classification] SET [created_at] = ''2024-11-04T09:03:54.0089398+00:00''
    WHERE [id] = 3;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [calculator_run_classification] SET [created_at] = ''2024-11-04T09:03:54.0089401+00:00''
    WHERE [id] = 4;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    EXEC(N'UPDATE [calculator_run_classification] SET [created_at] = ''2024-11-04T09:03:54.0089404+00:00''
    WHERE [id] = 5;
    SELECT @@ROWCOUNT');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241104090354_AddNewColumnLapcapFileNameToLapcapDataMaster', N'8.0.7');
END;
GO
