...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20260910120849_RemoveUnusedObligationAndSubmitterColumns")]
    partial class RemoveUnusedObligationAndSubmitterColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultCancelledProducerEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_cancelled_producer", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultCommsCostEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_comms_cost", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultLaDisposalCostDataEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_la_disposal_cost", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultLapcapDataEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_lapcap_data", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultLateReportingTonnageEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_late_reporting_tonnage", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultOnePlusFourApportionmentEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_one_plus_four_apportionment", (string)null);
                });

            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalcResultParameterOtherCostEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_parameter_other_cost", (string)null);
                });
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.ProducerFeeDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ProducerFeesId")
                        .HasColumnType("int")
                        .HasColumnName("producer_fees_id");

                    b.HasKey("Id");

                    b.HasIndex("ProducerFeesId");

                    b.ToTable("calc_result_producer_fee_detail", (string)null);
                });
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.ProducerSelfManagedConsumerWaste", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("calc_result_smcw_producer", (string)null);
                });
                    ...
                    b.OwnsOne("EPR.Calculator.API.Data.DataModels.CalcResultCancelledProducer", "CancelledProducer", b1 =>
                        {
                            ...
                            b1.OwnsOne("EPR.Calculator.API.Data.DataModels.LastTonnage", "LastTonnage", b2 =>
                                {
                                    ...
                                    b2.ToTable("calc_result_cancelled_producer");
                            ...
                            b1.Navigation("LastTonnage");

                            b1.Navigation("LatestInvoice");
                        });

                    b.Navigation("CancelledProducer")
                        .IsRequired();
                });
                            ...
                            b1.OwnsMany("EPR.Calculator.API.Data.DataModels.MaterialCommsCostData", "MaterialCosts", b2 =>
                                {
                                    ...
                                    b2.Navigation("CommsCost")
                                        .IsRequired();
                                });

                            b1.Navigation("CommsCostByCountry")
                                .IsRequired();

                            b1.Navigation("CommsCostUkWide")
                                .IsRequired();

                            b1.Navigation("MaterialCosts");

                            b1.Navigation("OnePlusFourApportionment")
                                .IsRequired();
                        });

                    b.Navigation("CommsCost")
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("EPR.Calculator.API.Data.DataModels.CalcResultLateReportingTonnage", "LateReportingTonnage", b1 =>
                        {
                            ...
                            b1.Navigation("MaterialTonnages");
                        });

                    b.Navigation("LateReportingTonnage")
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("EPR.Calculator.API.Data.DataModels.CalcResultOnePlusFourApportionment", "OnePlusFourApportionment", b1 =>
                        {
                            ...
                            b1.OwnsOne("EPR.Calculator.API.Data.DataModels.ByCountryCost", "LADataPrepCharge", b2 =>
                                {
                                    ...
                                    b2.ToTable("calc_result_one_plus_four_apportionment");
                            ...
                            b1.Navigation("LADataPrepCharge")
                                .IsRequired();

                            b1.Navigation("LaDisposalCost")
                                .IsRequired();
                        });

                    b.Navigation("OnePlusFourApportionment")
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("EPR.Calculator.API.Data.DataModels.CalcResultParameterOtherCost", "ParameterOtherCost", b1 =>
                        {
                            ...
                            b1.OwnsOne("EPR.Calculator.API.Data.DataModels.ByCountryApportionment", "CountryApportionment", b2 =>
                                {
                                    ...
                                    b2.ToTable("calc_result_parameter_other_cost");
                            ...
                            b1.Navigation("CountryApportionment")
                                .IsRequired();

                            b1.Navigation("LaDataPrepCharge")
                                .IsRequired();

                            b1.Navigation("MaterialityDecrease")
                                .IsRequired();

                            b1.Navigation("MaterialityIncrease")
                                .IsRequired();

                            b1.Navigation("SaOperatingCost")
                                .IsRequired();

                            b1.Navigation("SchemeSetupCost")
                                .IsRequired();

                            b1.Navigation("TonnageChangeDecrease")
                                .IsRequired();

                            b1.Navigation("TonnageChangeIncrease")
                                .IsRequired();
                        });

                    b.Navigation("ParameterOtherCost")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.ProducerFeeDetail", b =>
                {
                    b.HasOne("EPR.Calculator.API.Data.DataModels.ProducerFees", null)
                        .WithMany("Details")
                                    ...
                                    b2.OwnsOne("EPR.Calculator.API.Data.DataModels.ByCountryCost", "ByCountry", b3 =>
                                        {
                                            ...
                                            b3.WithOwner()
                                                .HasForeignKey("FeeWithBadDebtFeeDetailProducerFeeDetailId");
                                        });
                                    ...
                                    b2.OwnsOne("EPR.Calculator.API.Data.DataModels.ByCountryCost", "ByCountry", b3 =>
                                        {
                                            ...
                                            b3.WithOwner()
                                                .HasForeignKey("FeeWithBadDebtFeeDetailProducerFeesId");
                                        });
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.ProducerSelfManagedConsumerWaste", b =>
                {
                    b.HasOne("EPR.Calculator.API.Data.DataModels.SelfManagedConsumerWaste", null)
                        .WithMany("ProducerTotals")
                        .HasForeignKey("SmcwId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
