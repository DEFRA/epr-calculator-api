...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20260703151838_AddProducerFeesAndRenameProjected")]
    partial class AddProducerFeesAndRenameProjected
    {
        /// <inheritdoc />
                                    ...
                                    b2.OwnsOne("EPR.Calculator.API.Data.DataModels.DisposalFee", "DisposalFee", b3 =>
                                        {
                                            ...
                                            b3.Property<decimal>("SWCWTonnage")
                                                .HasPrecision(18, 6)
                                                .HasColumnType("decimal(18,6)");
                                            ...
                                            b3.OwnsOne("EPR.Calculator.API.Data.DataModels.RamTonnage", "HdcRamTonnage", b4 =>
                                                {
                                                    b4.Property<int>("DisposalFeeMaterialFeeProducerFeeDetailProducerFeesId")
                                                        .HasColumnType("int");
                                            ...
                                            b3.OwnsOne("EPR.Calculator.API.Data.DataModels.RamTonnage", "HhRamTonnage", b4 =>
                                                {
                                                    b4.Property<int>("DisposalFeeMaterialFeeProducerFeeDetailProducerFeesId")
                                                        .HasColumnType("int");
                                            ...
                                            b3.OwnsOne("EPR.Calculator.API.Data.DataModels.RamTonnageGroup", "NetReportedTonnage", b4 =>
                                                {
                                                    b4.Property<int>("DisposalFeeMaterialFeeProducerFeeDetailProducerFeesId")
                                                        .HasColumnType("int");
                                            ...
                                            b3.OwnsOne("EPR.Calculator.API.Data.DataModels.RamTonnage", "PbRamTonnage", b4 =>
                                                {
                                                    b4.Property<int>("DisposalFeeMaterialFeeProducerFeeDetailProducerFeesId")
                                                        .HasColumnType("int");
                                            ...
                                            b3.OwnsOne("EPR.Calculator.API.Data.DataModels.RamTonnage", "TotalRamTonnage", b4 =>
                                                {
                                                    b4.Property<int>("DisposalFeeMaterialFeeProducerFeeDetailProducerFeesId")
                                                        .HasColumnType("int");
                                            ...
                                            b3.Navigation("HdcRamTonnage")
                                                .IsRequired();

                                            b3.Navigation("HhRamTonnage")
                                                .IsRequired();

                                            b3.Navigation("NetReportedTonnage")
                                                .IsRequired();

                                            b3.Navigation("PbRamTonnage")
                                                .IsRequired();

                                            b3.Navigation("PricePerTonne")
                                                .IsRequired();

                                            b3.Navigation("TotalRamTonnage")
                                                .IsRequired();
                                        });
