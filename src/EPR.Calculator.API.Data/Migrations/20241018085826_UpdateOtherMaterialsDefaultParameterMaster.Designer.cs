...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20241018085826_UpdateOtherMaterialsDefaultParameterMaster")]
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 18, 9, 58, 26, 352, DateTimeKind.Local).AddTicks(2299),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 18, 9, 58, 26, 352, DateTimeKind.Local).AddTicks(2303),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 10, 18, 9, 58, 26, 352, DateTimeKind.Local).AddTicks(2305),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 10, 18, 9, 58, 26, 352, DateTimeKind.Local).AddTicks(2307),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 10, 18, 9, 58, 26, 352, DateTimeKind.Local).AddTicks(2309),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
