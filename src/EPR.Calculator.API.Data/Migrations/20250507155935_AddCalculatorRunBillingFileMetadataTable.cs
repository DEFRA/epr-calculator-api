        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    billing_csv_filename = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    billing_json_filename = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    billing_file_created_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    billing_file_created_by = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    billing_file_authorised_date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    billing_file_authorised_by = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
