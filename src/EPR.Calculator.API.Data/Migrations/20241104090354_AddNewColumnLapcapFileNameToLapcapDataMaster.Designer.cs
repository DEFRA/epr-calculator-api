...
namespace EPR.Calculator.API.Data.Migrations
{
    ...
    [Migration("20241104090354_AddNewColumnLapcapFileNameToLapcapDataMaster")]
            ...
            modelBuilder.Entity("EPR.Calculator.API.Data.DataModels.CalculatorRunClassification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 11, 4, 9, 3, 54, 8, DateTimeKind.Local).AddTicks(9390),
                            CreatedBy = "Test User",
                            Status = "IN THE QUEUE"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 11, 4, 9, 3, 54, 8, DateTimeKind.Local).AddTicks(9395),
                            CreatedBy = "Test User",
                            Status = "RUNNING"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 11, 4, 9, 3, 54, 8, DateTimeKind.Local).AddTicks(9398),
                            CreatedBy = "Test User",
                            Status = "UNCLASSIFIED"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 11, 4, 9, 3, 54, 8, DateTimeKind.Local).AddTicks(9401),
                            CreatedBy = "Test User",
                            Status = "PLAY"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 11, 4, 9, 3, 54, 8, DateTimeKind.Local).AddTicks(9404),
                            CreatedBy = "Test User",
                            Status = "ERROR"
                        });
                });
