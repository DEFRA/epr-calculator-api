namespace EPR.Calculator.API.UnitTests.Builder.Summary.SchemeAdministratorSetupCosts
{
    ...
    [TestClass]
    public class SchemeAdministratorSetupCostsSummaryTests
    {
        ...
        {
            // Act
            var result = SchemeAdministratorSetupCostsSummary.GetHeaders().ToList();

            var expectedResult = new List<CalcResultSummaryHeader>();
            expectedResult.AddRange([
                new CalcResultSummaryHeader { Name = $"{SchemeAdministratorSetupCostsHeaders.OneOffFeeSetupCostsWithoutBadDebtProvisionTitle}", ColumnIndex = 224 },
                new CalcResultSummaryHeader { Name = $"{SchemeAdministratorSetupCostsHeaders.BadDebtProvisionTitle}", ColumnIndex = 225 },
                new CalcResultSummaryHeader { Name = $"{SchemeAdministratorSetupCostsHeaders.OneOffFeeSetupCostsWithBadDebtProvisionTitle}", ColumnIndex = 226 }
            ]);
        ...
        {
            // Act
            var result = SchemeAdministratorSetupCostsSummary.GetBadDebtProvision(_calcResult);
