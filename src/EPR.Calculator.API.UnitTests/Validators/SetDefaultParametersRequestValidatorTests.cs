...
public class SetDefaultParametersRequestValidatorTests
{
    ...
    public async Task Validate_ReturnsError_WhenCurrencyValueIsInvalidFormat()
    {
        ...
        result.ShouldHaveValidationErrorFor(
                $"{nameof(SetDefaultParametersRequest.Parameters)}[{index}].{nameof(SetDefaultParametersRequest.ParameterValue.Value)}")
            .WithErrorMessage($"The parameter {CurrencyId} is not a valid currency value. It can only include numbers, commas, decimal points and a pound symbol (£).");
    }
    ...
    public async Task Validate_ReturnsError_WhenTonnageValueIsInvalidFormat()
    {
        ...
        result.ShouldHaveValidationErrorFor(
                $"{nameof(SetDefaultParametersRequest.Parameters)}[{index}].{nameof(SetDefaultParametersRequest.ParameterValue.Value)}")
            .WithErrorMessage($"The parameter {TonnageId} is not a valid tonnage value. It can only include numbers, commas, decimal points and a tonnage symbol (t).");
    }
    ...
    public async Task Validate_ReturnsError_WhenDecimalValueIsInvalidFormat()
    {
        ...
        result.ShouldHaveValidationErrorFor(
                $"{nameof(SetDefaultParametersRequest.Parameters)}[{index}].{nameof(SetDefaultParametersRequest.ParameterValue.Value)}")
            .WithErrorMessage($"The parameter {FactorId} is not a valid decimal value. It can only include numbers, commas and decimal points.");
    }
