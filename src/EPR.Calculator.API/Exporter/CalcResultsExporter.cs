...
namespace EPR.Calculator.API.Exporter
{
    public class CalcResultsExporter : ICalcResultsExporter<CalcResult>
    {
        ...
        public void Export(CalcResult results)
        {
            ...
            {
                PrepareOnePlusFourApportionment(results.CalcResultOnePlusFourApportionment, csvContent);
            }
        ...
        private static void PrepareOnePlusFourApportionment(CalcResultOnePlusFourApportionment calcResult1Plus4Apportionment, StringBuilder csvContent)
        {
            csvContent.AppendLine();
            csvContent.AppendLine();
