...
namespace EPR.Calculator.API.Services.Abstractions
{
    ...
    public interface IBillingFileService
    {
        ...
        Task<ServiceProcessResponseDto> StartGeneratingBillingFileAsync(
            int runId,
            string userName,
            CancellationToken cancellationToken);
        ...
        Task<bool> WasBillingGeneratedAfterLatestInstructions(int runId, CancellationToken cancellationToken);
    }
}
