...
namespace EPR.Calculator.API.Services
{
    public class BlobStorageService
    {
        ...
        public BlobStorageService(BlobServiceClient blobServiceClient, IConfiguration configuration)
        {
            ...
            var containerClient = blobServiceClient.GetBlobContainerClient(settings.ContainerName ?? throw new ArgumentNullException("Container name is missing in configuration."));
            _blobClient = containerClient.GetBlobClient(settings.CsvFileName ?? throw new ArgumentNullException("CSV file name is missing in configuration."));
        }
        ...
        public async Task<string?> GetResultFileContentAsync()
        {
            ...
            {
                // Consider using logging to log this exception.
