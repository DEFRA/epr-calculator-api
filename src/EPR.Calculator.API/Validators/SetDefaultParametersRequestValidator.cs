    ...
    private sealed class ParameterValueValidator : AbstractValidator<SetDefaultParametersRequest.ParameterValue>
    {
            ...
            ValidationContext<SetDefaultParametersRequest.ParameterValue> context)
        {
            ...
            (
                ...
                "currency",
                "It can only include numbers, commas, decimal points and a pound symbol (£)."
            );
            ...
            (
                ...
                "tonnage",
                "It can only include numbers, commas, decimal points and a tonnage symbol (t)."
            );
            ...
            (
                ...
                "decimal",
                "It can only include numbers, commas and decimal points."
            );
        }
