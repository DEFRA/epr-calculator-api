    ...
    public class CalcResultSummaryBuilder : ICalcResultSummaryBuilder
    {
        ...
        public CalcResultSummary Construct(CalcResultsRequestDto resultsRequestDto, CalcResult calcResult)
        {
            ...
            if (producerDetailList.Count > 0)
            {
                ...
                //Section-(1) & (2a)
                result.TotalFeeforLADisposalCostswoBadDebtprovision1 = GetTotalDisposalCostswoBadDebtprovision1(producerDisposalFees);
                result.BadDebtProvisionFor1 = GetTotalBadDebtprovision1(producerDisposalFees);
                result.TotalFeeforLADisposalCostswithBadDebtprovision1 = GetTotalDisposalCostswithBadDebtprovision1(producerDisposalFees);

                result.TotalFeeforCommsCostsbyMaterialwoBadDebtProvision2A = GetTotalCommsCostswoBadDebtprovision2A(producerDisposalFees);
                ...
                result.SAOperatingCostsWoTitleSection3 = GetSAOperatingCostsTotalWithoutBadDebtProvisionTitleSection3(calcResult);
                result.BadDebtProvisionTitleSection3 = GetSAOperatingCostsBadDebtProvisionTitleSection3(result.SAOperatingCostsWoTitleSection3, calcResult);
                result.SAOperatingCostsWithTitleSection3 = GetSAOperatingCostsTotalWithBadDebtProvisionTitleSection3(result);
        ...
        private static decimal GetSAOperatingCostsTotalWithBadDebtProvisionTitleSection3(CalcResultSummary result) => result.SAOperatingCostsWoTitleSection3 + result.BadDebtProvisionTitleSection3;
        ...
        private static decimal GetSAOperatingCostsEnglandTotalWithBadDebtProvisionSection3(Dictionary<MaterialDetail, CalcResultSummaryProducerDisposalFeesByMaterial> materialsCostSummary, Dictionary<MaterialDetail, CalcResultSummaryProducerCommsFeesCostByMaterial> costSummary, List<MaterialDetail> materials, CalcResult calcResult)
        {
            ...
            var producerPercentage = GetTotal1Plus2ABadDebtPercentage(GetTotalProducerDisposalFeeWithBadDebtProvision(materialsCostSummary), GetTotalProducerCommsFeeWithBadDebtProvision(costSummary), materials, calcResult);
