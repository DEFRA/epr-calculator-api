...
{
    public static class SchemeAdministratorSetupCostsHeaders
    {
        ...
        public static readonly string ProducerOneOffFeeWithBadDebtProvision = "5 Total Producer One-off fee for SA Set Up Costs In proportion to (1+2a) with Bad Debt provision";
        public static readonly string ProducerOneOffFeeWithoutBadDebtProvision = "5 Total Producer One-off fee for SA Set Up Costs In proportion to (1+2a) w/o Bad Debt provision";
