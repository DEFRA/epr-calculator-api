...
namespace EPR.Calculator.API {
    ...
    public class CommonResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Billing file was generated prior to the latest Accept/Reject instructions..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Run Id {0} does not have the correct billing status to send the file. Should be &apos;Completed&apos;, was: &apos;{1}&apos;..
        /// </summary>
        public static string BillingRunStatusInvalidForSend {
            get {
                return ResourceManager.GetString("BillingRunStatusInvalidForSend", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to BADEBT-P,COMC-AL,COMC-FC,COMC-GL,COMC-PC,COMC-PL,COMC-ST,COMC-WD,COMC-OT,COMC-UK,COMC-ENG,COMC-WLS,COMC-SCT,COMC-NIR,LAPC-ENG,LAPC-NIR,LAPC-SCT,LAPC-WLS,LRET-AL-R,LRET-AL,LRET-AL-G,LRET-FC-R,LRET-FC,LRET-FC-G,LRET-GL-R,LRET-GL,LRET-GL-G,LRET-OT-R,LRET-OT,LRET-OT-G,LRET-PC-R,LRET-PC,LRET-PC-G,LRET-PL-R,LRET-PL,LRET-PL-G,LRET-ST-R,LRET-ST,LRET-ST-G,LRET-WD-R,LRET-WD,LRET-WD-G,MATT-AD,MATT-AI,MATT-PD,MATT-PI,SAOC-ENG,SAOC-NIR,SAOC-SCT,SAOC-WLS,SCSC-ENG,SCSC-NIR,SCSC-SCT,SCSC-WLS,TONT-AD,TONT-AI,TONT-PD,TONT-PI [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Run is not in a valid state to start generating a Billing File..
        /// </summary>
        public static string InvalidRunStatusForBillingFileGeneration {
            get {
                return ResourceManager.GetString("InvalidRunStatusForBillingFileGeneration", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Relative year cannot be null or empty.
        /// </summary>
        public static string RelativeYearEmpty {
            get {
                return ResourceManager.GetString("RelativeYearEmpty", resourceCulture);
            }
        }
