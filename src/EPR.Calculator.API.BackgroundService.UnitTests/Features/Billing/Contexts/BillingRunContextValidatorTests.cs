...
public class BillingRunContextValidatorTests : TestsFor<BillingRunContextValidator>
{
    ...
    [TestMethod]
    public void Should_not_error_when_run_is_valid(RunClassification classificationId)
    {
        var preValidationContext = CreatePreValidationContext(classification: classificationId);
