...
namespace EPR.Calculator.API.BackgroundService.UnitTests.Exporter.JsonExporter
{
    [TestClass]
    public class BillingFileJsonWriterTests
    {
        ...
        private static async Task<byte[]> WriteJson(
            BackgroundService.Features.BillingRuns.Contexts.BillingRunContext runContext,
