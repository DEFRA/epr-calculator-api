...
namespace EPR.Calculator.API.BackgroundService.UnitTests.Exporter.CsvExporter.OtherCosts
{
    [TestClass]
    public class CalcResultParameterOtherCostExporterTests
    {
        ...
        public void CalcResultParameterOtherCostExporter_CanCallExport()
        {
            ...
            var expected = new[] {
                ...
                new[] { "4 Country Apportionment %","43.83561644%","19.17808219%","24.65753425%","12.32876712%","100.00000000%" },
                new string[] {},
                new[] { "5 Scheme Annual Set-up Cost","£17500.00","£23400.00","£12400.00","£9450.00","£62750.00" },
                new string[] {},
                new[] { "6 Bad Debt Provision","6.00%" },
                new string[] {},
                new[] { "7 Materiality","Amount £","%" },
                new[] { "Increase","£5000.00","2.00%" },
                new[] { "Decrease","-£1000.00","-1.00%" },
                new[] { "8 Tonnage Change","Amount £","%" },
