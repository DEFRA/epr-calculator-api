...
namespace EPR.Calculator.API.BackgroundService.UnitTests.Exporter.CsvExporter.LaDisposalCost
{
    [TestClass]
        ...
        public void Export_ShouldIncludeLaDisposalCostData_PreModulation()
        {
            ...
            var expected = new[] {
                ...
                new[] { "Material",
                        ...
                        "Household Tonnage + Late Reporting Tonnage + Public Bin Tonnage + Household Drinks Containers Tonnage",
