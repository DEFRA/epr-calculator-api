...
namespace EPR.Calculator.API.BackgroundService.UnitTests.Exporter.CsvExporter.Lapcap
{
    [TestClass]
    public class CalcResultLapcapDataExporterTests
    {
        ...
        public void ExportTest_ShouldShowCorrectHeaderAndRows()
        {
            ...
            var expected = new[] {
                ...
                new string[] { "Material"                  ,"England LA Disposal Cost","Wales LA Disposal Cost","Scotland LA Disposal Cost","Northern Ireland LA Disposal Cost","1 LA Disposal Cost Total UK" },
                ...
                new string[] { "1 Country Apportionment %",            "54.04873246%",          "12.18311592%",             "24.26778243%",                      "9.50036919%",           "100.00000000%" },
                new string[] {}
            };
