...
{
    Task LoadData(CalculatorRunContext runContext, CancellationToken cancellationToken);
}
...
{
    [ActivityTrace]
    public async Task LoadData(CalculatorRunContext runContext, CancellationToken cancellationToken)
    {
