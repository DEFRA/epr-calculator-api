...
public class ProducerPomAlignerTests
{
    ...
    [TestMethod]
    public void Align_WithMultipleRegistrationsForSameOrganisation_PicksHasH2True()
    {
    ...
    [TestMethod]
    public void Align_WithMultipleRegistrationsAllHasH2False_PicksFirstOccurrence()
    {
        var organisations = new[]
        {
